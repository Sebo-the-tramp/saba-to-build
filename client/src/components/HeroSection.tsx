...
> = {
  it: {
    ...
    subtitle: "Persone - idee - sport",
    primaryCta: "Programma",
    secondaryCta: "DM Instagram",
    meta: "13 Giugno · 14:00 → 22:00",
    note: "Vieni quando preferisci. Verso le 18 beviamo qualcosa. Nessun invito: passa e basta.",
  },
  en: {
    season: "Next meetup",
    location: "Val di Fiemme",
    ...
    subtitle: "People - ideas - sport",
    primaryCta: "Schedule",
    secondaryCta: "DM Instagram",
    meta: "13 June · 14:00 → 22:00",
    note: "Come whenever you prefer. Around 18:00 we have drinks. No invite needed: just come.",
  },
};
