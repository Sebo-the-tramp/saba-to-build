  ...
  return (
    <section id="galleria" className="bg-[#03040c] py-24 text-white min-h-screen">
      <div className="mx-auto w-full px-4 sm:px-10 lg:px-16">
        ...
        >
          <p className="text-xs uppercase tracking-[0.35em] text-slate-500">Vibes</p>
          <h2 className="mt-4 font-heading text-4xl md:text-5xl">Il playground reale.</h2>
          <p className="mt-4 text-lg text-slate-300">Desk modulari, VR, cucina, cortile. Ogni stanza cambia con i progetti.</p>
        </motion.div>
